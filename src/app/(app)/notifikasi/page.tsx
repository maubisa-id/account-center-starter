...
// Selaras dengan directus-acme/docs/notifikasi.md §5 (kunci user_preferences).
...
const EMAIL_PREFS = [
  ...
  { key: "email_produk", label: "Pembaruan produk", desc: "Kabar fitur baru dan peningkatan layanan Acme.", defaultOn: true },
...
const CHANNEL_PREFS = [
  ...
  { key: "inapp_push", label: "Push di dalam aplikasi", desc: "Notifikasi saat kamu membuka dashboard Acme (segera tersedia).", defaultOn: false },
];
  ...
  return (
    <div className="space-y-8">
      <SectionTitle
        ...
        desc="Atur email dan notifikasi apa saja yang ingin kamu terima dari Acme."
      ...
      <Reveal delay={60}>
        <Panel innerClassName="p-6 sm:p-8">
          ...
          <p className="mt-1 text-sm text-zinc-500">Dikirim dari no-reply@example.com ke {user.email}.</p>
