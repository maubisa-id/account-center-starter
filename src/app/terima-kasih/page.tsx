...
export const metadata = { title: "Pembayaran diterima · Acme" };

export const dynamic = "force-dynamic";

// Domain utama Acme untuk tombol "pulang". Bisa ditimpa lewat env bila domain berbeda.
const MAIN_SITE = process.env.NEXT_PUBLIC_MAIN_SITE_URL ?? "https://example.com";
