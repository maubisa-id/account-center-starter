...
// disimpan ke Directus Files (produksi) / lokal (dev). Mengembalikan { url } untuk
// dipasang ke field profil; penyimpanan ke users.avatar_url terjadi saat simpan profil.
