...
// Preferensi user (minat/tujuan) untuk PERSONALISASI. Dipakai app.maubisa.id & kelas.maubisa.id
// yang berbagi sesi SSO (cookie .maubisa.id) — cukup panggil endpoint ini untuk user aktif.
