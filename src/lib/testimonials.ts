...
export const MAUBISA_TESTIMONIALS: Testimonial[] = [
  {
    avatarSrc: "https://picsum.photos/seed/maubisa-testi-aidah/160/160",
    name: "Aidah",
  ...
  {
    avatarSrc: "https://picsum.photos/seed/maubisa-testi-kinan/160/160",
    name: "Kinan",
  ...
  {
    avatarSrc: "https://picsum.photos/seed/maubisa-testi-anin/160/160",
    name: "Anin",
    handle: "Ilmu Komunikasi · Untirta",
