/**
 * Sistem email transaksional & lifecycle Acme.
 *
 ...
 *
 * Bahasa desain: editorial Acme. Header band brand (biru gradasi) dengan wordmark
...
// ── Tokens (disamakan dengan token desain website utama example.com) ───────────
...
const LOGO_DARK = "https://cdn.example.com/public/cms/f39f0c03-bf4a-4550-abcf-956827f3b8b1.png";
...
const CDN_ASSETS: Record<string, string> = {
  "hero-security": "https://cdn.example.com/public/cms/fccd0e4a-05ad-4e0c-b805-91b9bc5075f2.png",
  "hero-welcome": "https://cdn.example.com/public/cms/917131a3-fda4-4480-b58a-2ced0bb81330.png",
  "hero-payment": "https://cdn.example.com/public/cms/39a77f64-8403-4a04-92c2-5ea30b0fcac3.png",
  "hero-billing": "https://cdn.example.com/public/cms/c450ebf0-94ae-476f-a64b-26fc1822ff94.png",
  "hero-event": "https://cdn.example.com/public/cms/75740a36-d13e-4a54-ad39-3ed5f78aa0d2.png",
  "hero-learning": "https://cdn.example.com/public/cms/4c7ecdd7-7264-46e4-ac1c-49e379cc43b0.png",
  "hero-thesis": "https://cdn.example.com/public/cms/38069a57-b889-4f76-b752-cfb9ce7d2e94.png",
  "hero-community": "https://cdn.example.com/public/cms/ec23cb3d-018b-4cab-bc0a-f5f45bb6490d.png",
  "badge-success": "https://cdn.example.com/public/cms/28418f39-3a3a-4d4c-8a23-c89ae5b9fbca.png",
  "badge-info": "https://cdn.example.com/public/cms/9dada1da-8ffe-4d5c-8de9-d811585d6ff4.png",
  "badge-warning": "https://cdn.example.com/public/cms/5677d588-7102-4487-ba97-e6cd3d5bddd2.png",
  "badge-danger": "https://cdn.example.com/public/cms/5bd5f67c-9d48-4b85-8deb-2f9371a1b4e3.png",
};
...
const HERO_FALLBACK: Record<string, string> = {
  ...
  "Tagihan": "payment", "Langganan": "payment", "Kabar Acme": "community",
...
const FROM: Record<Channel, string> = {
  akun: env("MAIL_FROM_AKUN") || "Keamanan Acme <no-reply@example.com>",
  tagihan: env("MAIL_FROM_TAGIHAN") || "Tagihan Acme <notifikasi@example.com>",
  info: env("MAIL_FROM_INFO") || "Acme <notifikasi@example.com>",
};
...
<style>
  @font-face{font-family:'Cabinet Grotesk';src:url('https://example.com/fonts/cabinet-grotesk-800.woff2') format('woff2');font-weight:800;font-display:swap}
  @font-face{font-family:'Cabinet Grotesk';src:url('https://example.com/fonts/cabinet-grotesk-700.woff2') format('woff2');font-weight:700;font-display:swap}
  @font-face{font-family:'Satoshi';src:url('https://example.com/fonts/satoshi-400.woff2') format('woff2');font-weight:400;font-display:swap}
  @font-face{font-family:'Satoshi';src:url('https://example.com/fonts/satoshi-500.woff2') format('woff2');font-weight:500;font-display:swap}
  @font-face{font-family:'Satoshi';src:url('https://example.com/fonts/satoshi-700.woff2') format('woff2');font-weight:700;font-display:swap}
  ...
  <tr><td align="center">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:${CARD};border-radius:12px;overflow:hidden;box-shadow:0 1px 2px rgba(20,20,20,.05),0 10px 26px -16px rgba(20,20,20,.14);border:1px solid #edf0f5">
      ...
      <tr><td class="mx" style="padding:28px 40px 0;background:${CARD}">
        <img src="${LOGO_DARK}" alt="Acme" height="38" style="height:38px;width:auto;display:block;border:0;outline:none">
      </td></tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
      <tr><td style="padding:22px 28px 4px;text-align:center">
        ${o.lifecycle ? `<p style="margin:0 0 14px;font-family:${SANS};font-size:11px;line-height:1.7;color:${MUTED}">Kamu menerima email ini sesuai preferensi notifikasi di akunmu. <a href="https://akun.example.com/notifikasi" style="color:${SUBINK};text-decoration:underline">Kelola preferensi</a>.</p>` : ""}
        <img src="${LOGO_DARK}" alt="Acme" height="20" style="height:20px;width:auto;display:inline-block;border:0;outline:none;margin:0 0 12px;opacity:.85">
        ...
        <p style="margin:0 0 8px;font-family:${SANS};font-size:11px;line-height:1.7;color:${MUTED}"><a href="https://www.instagram.com/acme.official/" style="color:${MUTED};text-decoration:none">Instagram</a> &middot; <a href="https://www.linkedin.com/company/acme-id" style="color:${MUTED};text-decoration:none">LinkedIn</a> &middot; <a href="https://www.tiktok.com/@example.com" style="color:${MUTED};text-decoration:none">TikTok</a></p>
        <p style="margin:0 0 10px;font-family:${SANS};font-size:11px;line-height:1.7;color:${MUTED}"><a href="https://example.com/pusat-kepercayaan/hukum/kebijakan-privasi" style="color:${MUTED};text-decoration:none">Kebijakan Privasi</a> &middot; <a href="https://example.com/pusat-kepercayaan/hukum/syarat-ketentuan" style="color:${MUTED};text-decoration:none">Syarat &amp; Ketentuan</a> &middot; <a href="https://example.com/pusat-kepercayaan/ringkasan" style="color:${MUTED};text-decoration:none">Pusat Kepercayaan</a></p>
        <p style="margin:0;font-family:${SANS};font-size:11px;line-height:1.7;color:${MUTED}">Acme Inc &middot; Jakarta, Indonesia<br>Email otomatis, mohon tidak membalas langsung. &copy; ${year} Acme.</p>
      </td></tr>
    </table>
  </td></tr>
</table></body></html>`;
...
export function otpEmail(otp: string, type: "sign-in" | "email-verification" | "forget-password" | "change-email"): Out {
  const map = {
    "sign-in": { subject: "Kode masuk Acme kamu", eyebrow: "Kode Masuk", heading: "Ini kode masuk kamu", intro: "Ada permintaan masuk ke akun Acme kamu. Pakai kode di bawah ini untuk melanjutkan." },
    "email-verification": { subject: "Verifikasi email Acme kamu", eyebrow: "Verifikasi", heading: "Tinggal satu langkah lagi", intro: "Sedikit lagi akun kamu aktif. Masukkan kode di bawah untuk memverifikasi alamat email kamu." },
...
export function setPasswordEmail(url: string, name?: string): Out {
  return build("Selamat bergabung di Acme, atur kata sandi kamu", layout({
    channel: "akun", category: "Keamanan Akun", hero: "welcome", preheader: "Yuk, atur kata sandi akun Acme kamu", eyebrow: "Akun Baru", heading: "Selamat bergabung di Acme",
    intro: `${hi(name)} akun Acme kamu sudah kami siapkan. Demi keamanan, kami tidak pernah mengirim kata sandi lewat email. Yuk, atur kata sandi kamu sendiri lewat tombol di bawah.`,
    cta: { label: "Atur kata sandi kamu", url },
  }));
}

export function magicLinkEmail(url: string, name?: string): Out {
  return build("Tautan masuk ke akun Acme kamu", layout({
    channel: "akun", category: "Keamanan Akun", preheader: "Tautan masuk sekali pakai", eyebrow: "Masuk", heading: "Masuk tanpa ribet",
    intro: `${hi(name)} tinggal klik tombol di bawah untuk langsung masuk ke akun Acme kamu, tanpa perlu kata sandi. Tautannya berlaku 10 menit dan cuma bisa dipakai sekali.`,
...
export function resetPasswordEmail(url: string): Out {
  ...
  return build("Atur ulang kata sandi Acme kamu", layout({
    ...
    intro: "Kami menerima permintaan untuk mengatur ulang kata sandi akun Acme kamu. Kalau ini memang kamu, klik tombol di bawah untuk membuat kata sandi baru.",
...
export function passwordChangedEmail(o: { name?: string; when?: string; manageUrl?: string }): Out {
  ...
  return build("Kata sandi kamu berhasil diubah", layout({
    ...
    intro: `${hi(o.name)} kata sandi akun Acme kamu baru saja diganti. Kalau ini kamu, berarti semua beres. Kalau bukan, segera amankan akunmu ya.`,
...
export function newDeviceLoginEmail(o: { name?: string; device: string; location?: string; when?: string; resetUrl?: string }): Out {
  ...
  return build("Ada login baru di akun Acme kamu", layout({
    ...
    intro: `${hi(o.name)} kami mendeteksi login baru ke akun Acme kamu. Kami kabari biar kamu selalu tahu apa yang terjadi di akunmu.`,
...
export function twoFactorChangedEmail(o: { name?: string; enabled: boolean; when?: string }): Out {
  ...
  return build(o.enabled ? "Verifikasi 2 langkah aktif di akunmu" : "Verifikasi 2 langkah dinonaktifkan", layout({
    ...
    intro: `${hi(o.name)} ada perubahan pada pengaturan keamanan akun Acme kamu.`, blocks,
  }));
}
...
export function welcomeEmail(o: { name?: string; loginUrl: string }): Out {
  ...
  return build("Selamat datang di Acme", layout({
    channel: "info", category: "Selamat Datang", preheader: "Akun Acme kamu sudah aktif", eyebrow: "Selamat Datang", heading: "Senang kamu di sini",
    intro: `${hi(o.name)} selamat bergabung di Acme. Kami bukan sekadar platform belajar, tapi ruang tumbuh yang nemenin kamu di setiap fase. Yuk, mulai perjalananmu.`,
...
export function welcomeAccessEmail(o: { name?: string; email: string; loginUrl: string; setPasswordUrl?: string; productName?: string }): Out {
  ...
  return build("Selamat bergabung di Acme, ini akses masuk kamu", layout({
    channel: "akun", category: "Keamanan Akun", hero: "welcome", preheader: "Akun Acme kamu sudah siap", eyebrow: "Akun Baru", heading: "Akun kamu sudah siap",
...
export function receiptEmail(o: { orderId: string; itemName: string; amount: string; method: string; date: string; invoiceUrl: string; name?: string }): Out {
  ...
  return build(`Struk pembayaran Acme, ${o.orderId}`, layout({
...
export function subscriptionActiveEmail(o: { name?: string; planName: string; periodEnd?: string; manageUrl: string }): Out {
  ...
  return build(`Selamat datang di ${o.planName}`, layout({
    ...
    intro: `${hi(o.name)} langgananmu sudah aktif. Terima kasih sudah bertumbuh bareng Acme.`,
...
export function winbackEmail(o: { name?: string; planName: string; offer?: string; resumeUrl: string }): Out {
  return build(`Kami merindukanmu di ${o.planName}`, layout({
    channel: "info", category: "Kabar Acme", preheader: "Kembali ke Acme", eyebrow: "Untuk Kamu", heading: "Kami merindukanmu",
...
export function thesisPaymentLinkEmail(o: { name?: string; amount: string; payUrl: string; note?: string }): Out {
  ...
  return build("Tagihan bimbingan skripsi Acme", layout({
...
export function productNewsEmail(o: { name?: string; title: string; body: string; ctaUrl: string; ctaLabel?: string }): Out {
  return build(o.title, layout({
    channel: "info", category: "Kabar Produk", preheader: esc(o.title), eyebrow: "Baru di Acme", heading: o.title,
