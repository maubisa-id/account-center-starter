...
// Baca preferensi user berdasarkan core_user_id (uuid). INI POLA yang dipakai app.maubisa.id
// & kelas.maubisa.id untuk personalisasi: mereka punya core_user_id tiap user, lalu membaca
