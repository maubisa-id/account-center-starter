...
export async function createGuestUserAndInvoice(
  ...
  // bukan produk katalog, perlakukan sebagai acara berbayar (Events). Sama persis dgn
  ...
  // LANGGANAN (mis. Pro) via GUEST: buat baris subscription "pending" lalu tautkan ke invoice
  ...
  if (isSub) {
    ...
    // pendaftaran recurring => dua tagihan bulanan untuk produk yang sama (mis. beli Pro dua
