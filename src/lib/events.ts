// Sumber acara Acme = CMS (Directus). Tim update event di panel Directus, Account
// Center MENARIK datanya (tanpa deploy). Event gratis (Free Events) didaftar di sini ->
// jadi entitlement 'free' di core (tanpa invoice). Event berbayar (Events) -> checkout.
//
...
const SAMPLE_EVENTS: MbEvent[] = [
  {
    id: "free-events-riset-juli",
    title: "Free Events: Menyusun Bab 1 Anti Revisi",
    description: "Sesi gratis membedah kerangka Bab 1 skripsi bareng mentor Acme.",
  ...
  {
    id: "free-events-produktif",
    title: "Free Events: Produktif Tanpa Burnout",
  ...
  {
    id: "events-pitching",
    title: "Events: Workshop Pitching Riset (Berbayar)",
...
const DEMO_EVENTS: MbEvent[] = [
  {
    ...
    title: "Events: Analisis Data Riset dengan Python",
  ...
  },
  {
    ...
    title: "Events: Personal Branding untuk Fresh Graduate",
    description:
...
// nominal yang ditagih = harga acara sebenarnya, BUKAN harga produk events tetap.
