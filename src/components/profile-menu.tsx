...
const LINKS: { href: string; label: string; icon: IconType; external?: boolean }[] = [
  ...
  { href: "https://example.com/bantuan", label: "Pusat bantuan", icon: IconHelp, external: true },
  { href: "https://example.com/kontak", label: "Hubungi kami", icon: IconMail, external: true },
];
