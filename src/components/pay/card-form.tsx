...
const ACCEPTED = [
  { id: "visa", src: "/pay/visa.png", alt: "Visa" },
  { id: "mastercard", src: "/pay/mastercard.png", alt: "Mastercard" },
  { id: "jcb", src: "/pay/jcb.png", alt: "JCB" },
] as const;
...
export function CardForm({
  ...
  return (
    <div className="mt-4 space-y-4 rounded-3xl border border-black/[0.06] bg-gradient-to-b from-white to-cream-50 p-4 sm:p-5">
      ...
      {/* Pratinjau kartu hidup (aset Untitled UI, varian gradient navigasi Acme) */}
