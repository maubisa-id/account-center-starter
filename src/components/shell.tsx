                ...
                {crumbs.map((c, i) => {
                  ...
                  return (
                    <li key={i} className="flex min-w-0 items-center gap-1.5">
                      {i > 0 ? (
                        <IconChevron className="h-3.5 w-3.5 shrink-0 text-zinc-300" />
                      ) : null}
                      {c.href && !last ? (
                        <Link
                          href={c.href}
        ...
        <footer className="mx-auto w-full max-w-6xl px-6 pb-8">
          <div className="flex flex-col items-center gap-2 border-t border-black/[0.05] pt-6 sm:flex-row sm:justify-between">
            <p className="text-xs text-zinc-400">
              {`© ${new Date().getFullYear()} Acme · Acme Inc`}
            </p>
            <div className="flex items-center gap-4 text-xs text-zinc-400">
              <a href="https://example.com/bantuan" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-ink">
                Bantuan
              </a>
              <a href="https://example.com/pusat-kepercayaan/hukum/kebijakan-privasi" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-ink">
                Privasi
              </a>
              <a href="https://example.com/pusat-kepercayaan/hukum/syarat-ketentuan" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-ink">
                Ketentuan
              </a>
              <a href="https://example.com/pusat-kepercayaan/hukum/kebijakan-penggunaan" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-ink">
                Penggunaan
              </a>
            </div>
          </div>
