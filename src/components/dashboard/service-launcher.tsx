...
// lini produk resmi (Acme Lulus/Berkembang/Mahir). SATU sumber = lib/services.activeServices,
// dipakai bersama Ringkasan & /akses (hindari duplikasi). Cookie Better Auth domain-wide
// `.example.com` membawa sesi, jadi "Buka" cukup tautan biasa. Dashboard yang belum live tampil
...
export function ServiceLauncher({
  ...
  subheading = "Lanjutkan dari tempat kamu berhenti. Satu login untuk semua layanan Acme.",
  onlyEnabled = false,
}: {
