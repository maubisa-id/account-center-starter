...
// Ikon aset kartu dari Untitled UI (untitleduico/react, shared-assets/credit-card).
// Paypass = simbol contactless; Mastercard = fallback logo jaringan bila tak terdeteksi.
...
// Penanda kartu NETRAL (bukan merek apa pun) untuk placeholder saat jaringan belum terdeteksi.
// Sekadar bentuk kartu + garis magnetik, agar tak menyiratkan Visa/Mastercard tertentu.
export const GenericCardMark = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg width="28" height="20" viewBox="0 0 28 20" fill="none" {...props}>
      <rect x="1" y="2.5" width="26" height="15" rx="2.5" stroke="currentColor" strokeWidth="1.5" opacity="0.75" />
      <rect x="1" y="6" width="26" height="3" fill="currentColor" opacity="0.55" />
    </svg>
  );
};
