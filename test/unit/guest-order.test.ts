...
describe("guest custom_field pack/parse", () => {
  it("normal: name + phone", () => {
    ...
    expect(parseGuestFields({ custom_field1: "budi@x.com", custom_field2: "events", custom_field3: packed }))
      .toEqual({ email: "budi@x.com", itemRef: "events", name: "Budi", phone: "0812" });
  });
