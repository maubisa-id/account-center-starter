# Acme Account Center — image produksi untuk demo (VPS / Coolify / Docker Compose).
...
#
# Build : docker build -t acme-akun .
# Run   : docker run -p 3000:3000 --env-file .env acme-akun
# (Migrasi & seed dijalankan sekali, lihat PANDUAN-DEMO.md § C.2.)
