# Sentry Runbook — Acme Account Center
...
| `provisioning` | `/api/provision` | Gagal membuat akun dari web utama (hand-off example.com → Pusat Akun). | Pastikan `PROVISION_SECRET` **sama** di web & Pusat Akun; validasi payload; cek DB. |
